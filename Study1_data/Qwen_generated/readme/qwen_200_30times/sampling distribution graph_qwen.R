...
library(Rmisc)
library(ggplot2) 
setwd('/Users/luyu/Library/CloudStorage/OneDrive-HKUST(Guangzhou)/GPT-survey/中文模型/qwen_200_30times')
data <- read.csv("china_cencus_qwen_6000.csv")
...
text(x = 4.095, y=10, labels = "4.095", pos = 4, col = "black", cex=0.7)
dev.off()
...
text(x = 0.408, y=35, labels = "40.8%", pos = 4, col = "black", cex=0.7)
dev.off()
